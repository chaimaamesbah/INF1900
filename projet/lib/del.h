...
Modifications :
    - Changement de la fonction allumerAmbre() et allumer() par Chaïmaa (7 novembre 2024), car la del ne s'allumais pas en ambre.
*/
...
private:
    ...
    const uint8_t pinRouge_ = PA4;
    const uint8_t pinVert_ = PA5;
};

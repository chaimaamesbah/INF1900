...
public:
    ...
    // Tourner :
    void tourner(uint8_t vitessePourcentageGauche, uint8_t vitessePourcentageDroite);
    ...
    void tournerSurPlaceDroite(uint8_t vitessePourcentage);
    void tournerSurPlaceGauche(uint8_t vitessePourcentage);
